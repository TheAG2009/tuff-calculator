...
function getRandomQuoteFromArray(arr, opKey) {
    if (!arr || arr.length === 0) return "✨ Keep going! ✨";
    ...
    lastQuoteMap[opKey] = candidate;
    return candidate;
}

function getQuoteByOperation(operation) {
    switch(operation) {
